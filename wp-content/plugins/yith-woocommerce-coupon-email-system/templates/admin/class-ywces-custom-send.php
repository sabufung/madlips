    ...
    public function output( $option ) {
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-custom-send">
                ...
                <button type="button" class="button-secondary ywces-send-test-email"><?php _e( 'Send Test Email', 'yith-woocommerce-coupon-email-system' ); ?></button>
                <div class="ywces-send-result send-progress"><?php _e( 'Sending test email...', 'yith-woocommerce-coupon-email-system' ); ?></div>
            </td>
        </tr>
    <?php
    }
