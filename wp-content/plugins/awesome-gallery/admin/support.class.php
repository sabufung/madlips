		...
		function _handle_submission(){
			...
			if (isset($_REQUEST['_wpnonce']) && wp_verify_nonce($_REQUEST['_wpnonce'], 'support-submit')){
				...
				if (empty($data['purchase_code']))
					$errors['purchase_code'] = __('Please enter CodeCanyon item purchase code. This code can be found at the <a href="http://codecanyon.net/downloads">Downloads page</a>, you need to click "Download" button and choose "License certificate and purchase code"', $this->options['namespace']);
