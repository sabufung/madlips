<div class="wrap asg-screen" id="asg-support-wrap" style="text-align: center">
	...
	<?php else: ?>
		<strong style="font-size: 15px; color: #555; font-weight: normal">
			...
			it will not be lost - please send a direct email to <a href="mailto:karev.n@gmail.com">karev.n@gmail.com</a></strong>
	<?php endif ?>
	<p style="text-align: center">
		<img src="<?php echo ASG_URL . "assets/admin/images/purr.png"?>">
		<br>
